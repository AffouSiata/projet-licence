...
const CATEGORY = {
	...
	eyebrow: 'Protection & Sécurité',
	description:
		'Protégez vos appareils contre virus, malwares et ransomwares. Les solutions des plus grands éditeurs à prix avantageux.',
	brand: '#059669',
	brandDark: '#065F46',
	icon: Shield,
	defaultQuery: 'antivirus',
	subcategories: [
		{ name: 'Toutes', slug: null, query: null },
		{ name: 'Kaspersky', slug: 'kaspersky', query: 'Kaspersky' },
		{ name: 'Norton', slug: 'norton', query: 'Norton' },
		{ name: 'Bitdefender', slug: 'bitdefender', query: 'Bitdefender' },
		{ name: 'ESET NOD32', slug: 'eset', query: 'ESET' },
		{ name: 'Avast', slug: 'avast', query: 'Avast' },
	],
	highlights: [
		{ icon: ShieldCheck, label: 'Protection temps réel' },
		{ icon: Smartphone, label: 'Multi-appareils' },
		...
		<>
			...
			<main className="min-h-screen bg-white">
				...
				>
					...
					<div
						aria-hidden
						className="absolute -bottom-40 -left-32 h-[400px] w-[400px] rounded-full bg-teal-400/10 blur-3xl"
					/>
						...
						<div className="grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
							<div className="max-w-2xl">
								...
								<div className="mt-7 flex flex-wrap gap-2.5">
									{CATEGORY.highlights.map(({ icon: HI, label }) => (
										...
										>
											<HI size={14} className="text-emerald-200" />
											{label}
										</div>
									))}
								</div>
							...
							<div className="hidden lg:flex lg:justify-end">
								<div className="relative">
									...
									<div className="absolute -bottom-3 -right-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-teal-400 shadow-xl shadow-teal-400/30">

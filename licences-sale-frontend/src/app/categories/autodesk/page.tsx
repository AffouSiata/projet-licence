...
const CATEGORY = {
	name: 'Autodesk',
	eyebrow: 'CAO & Modélisation 3D',
	description:
		'AutoCAD, Revit, 3ds Max, Maya. Logiciels professionnels Autodesk pour architectes, ingénieurs et designers 3D.',
	brand: '#0891B2',
	brandDark: '#0E7490',
	icon: PenTool,
	defaultQuery: 'Autodesk',
	subcategories: [
		{ name: 'Toutes', slug: null, query: null },
		{ name: 'AutoCAD 2025', slug: 'autocad-2025', query: 'AutoCAD' },
		{ name: 'Revit 2025', slug: 'revit-2025', query: 'Revit' },
		{ name: '3ds Max', slug: '3ds-max', query: '3ds Max' },
		{ name: 'Maya', slug: 'maya', query: 'Maya' },
		{ name: 'Inventor', slug: 'inventor', query: 'Inventor' },
		{ name: 'Civil 3D', slug: 'civil-3d', query: 'Civil 3D' },
	],
	highlights: [
		{ icon: Award, label: 'Licence officielle' },
		{ icon: Cloud, label: 'Activation cloud' },
		{ icon: Headphones, label: 'Support technique' },
	],
};
		...
		<>
			...
			<main className="min-h-screen bg-white">
				...
				>
					...
					<div
						aria-hidden
						className="absolute -bottom-40 -left-32 h-[400px] w-[400px] rounded-full bg-sky-400/10 blur-3xl"
					/>
						...
						<div className="grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
							<div className="max-w-2xl">
								<div className="mb-5 inline-flex items-center gap-2 rounded-full bg-white/12 px-3 py-1.5 backdrop-blur-sm ring-1 ring-white/20">
									<PenTool size={14} className="text-cyan-200" />
								...
								<div className="mt-7 flex flex-wrap gap-2.5">
									{CATEGORY.highlights.map(({ icon: HI, label }) => (
										...
										>
											<HI size={14} className="text-cyan-200" />
											{label}
										</div>
									))}
								</div>
							...
							<div className="hidden lg:flex lg:justify-end">
								<div className="relative">
									...
									<div className="absolute -bottom-3 -right-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-cyan-400 shadow-xl shadow-cyan-400/30">

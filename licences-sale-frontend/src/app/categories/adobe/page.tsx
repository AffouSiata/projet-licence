...
const CATEGORY = {
	...
	description:
		'Photoshop, Illustrator, Premiere Pro et toute la Creative Cloud. Les outils professionnels Adobe pour créatifs.',
	brand: '#DC2626',
	brandDark: '#991B1B',
	icon: Palette,
	defaultQuery: 'Adobe',
	subcategories: [
		...
		{ name: 'Creative Cloud', slug: 'creative-cloud', query: 'Creative Cloud' },
		{ name: 'Photoshop', slug: 'photoshop', query: 'Photoshop' },
		{ name: 'Illustrator', slug: 'illustrator', query: 'Illustrator' },
		{ name: 'Premiere Pro', slug: 'premiere-pro', query: 'Premiere Pro' },
		{ name: 'After Effects', slug: 'after-effects', query: 'After Effects' },
		{ name: 'Acrobat Pro', slug: 'acrobat-pro', query: 'Acrobat' },
	],
	highlights: [
		{ icon: Cloud, label: 'Creative Cloud inclus' },
		{ icon: RefreshCw, label: 'Mises à jour incluses' },
		{ icon: Sparkles, label: 'Outils créatifs' },
	],
};
		...
		<>
			...
			<main className="min-h-screen bg-white">
				...
				>
					...
					<div
						aria-hidden
						className="absolute -bottom-40 -left-32 h-[400px] w-[400px] rounded-full bg-pink-400/10 blur-3xl"
					/>
						...
						<div className="grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
							<div className="max-w-2xl">
								...
								<div className="mt-7 flex flex-wrap gap-2.5">
									{CATEGORY.highlights.map(({ icon: HI, label }) => (
										...
										>
											<HI size={14} className="text-pink-200" />
											{label}
										</div>
									))}
								</div>
							...
							<div className="hidden lg:flex lg:justify-end">
								<div className="relative">
									...
									<div className="absolute -bottom-3 -right-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-pink-400 shadow-xl shadow-pink-400/30">

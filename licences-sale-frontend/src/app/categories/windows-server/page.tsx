...
const CATEGORY = {
	name: 'Windows Server',
	eyebrow: 'Solutions Serveur Entreprise',
	description:
		'Windows Server et SQL Server pour entreprise. Licences officielles avec CAL inclus pour votre infrastructure.',
	brand: '#7C3AED',
	brandDark: '#5B21B6',
	icon: Server,
	defaultQuery: 'Server',
	subcategories: [
		...
		{ name: 'Server 2022', slug: 'server-2022', query: 'Server 2022' },
		{ name: 'Server 2019', slug: 'server-2019', query: 'Server 2019' },
		{ name: 'Server 2016', slug: 'server-2016', query: 'Server 2016' },
		{ name: 'SQL Server', slug: 'sql-server', query: 'SQL Server' },
	],
	highlights: [
		{ icon: Award, label: 'Licence officielle' },
		{ icon: Users, label: 'CAL inclus' },
		{ icon: Headphones, label: 'Support entreprise' },
	],
};
		...
		<>
			...
			<main className="min-h-screen bg-white">
				...
				>
					...
					<div
						aria-hidden
						className="absolute -bottom-40 -left-32 h-[400px] w-[400px] rounded-full bg-fuchsia-400/10 blur-3xl"
					/>
						...
						<div className="grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
							<div className="max-w-2xl">
								<div className="mb-5 inline-flex items-center gap-2 rounded-full bg-white/12 px-3 py-1.5 backdrop-blur-sm ring-1 ring-white/20">
									<Server size={14} className="text-violet-200" />
								...
								<div className="mt-7 flex flex-wrap gap-2.5">
									{CATEGORY.highlights.map(({ icon: HI, label }) => (
										...
										>
											<HI size={14} className="text-violet-200" />
											{label}
										</div>
									))}
								</div>
							...
							<div className="hidden lg:flex lg:justify-end">
								<div className="relative">
									...
									<div className="absolute -bottom-3 -right-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-fuchsia-400 shadow-xl shadow-fuchsia-400/30">

				...
				<div className="max-w-2xl mx-auto px-4 py-20">
					<div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
						...
						<p className="text-slate-500 mb-6">
							Votre commande <span className="font-semibold text-slate-700">#{orderComplete.orderNumber}</span> a été créée avec succès.
						</p>

						<div className="bg-slate-50 rounded-xl p-6 mb-6">
							<p className="text-sm text-slate-600 mb-4">
								Pour finaliser votre commande, contactez-nous via WhatsApp. Vous recevrez vos licences par email après paiement.
							</p>
			...
			<header className="bg-white border-b border-slate-200">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
					<div className="flex items-center justify-between">
						<Link href="/cart" className="inline-flex items-center gap-2 text-slate-600 hover:text-[#1B75BC] transition-colors">
							<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
							</svg>
							Retour au panier
						</Link>
						<h1 className="text-lg font-bold text-slate-900">Finaliser la commande</h1>
						<div className="w-20" />
					</div>
				</div>
			</header>
						...
						<form onSubmit={handleSubmit} className="space-y-5">
							...
							<div className="bg-amber-50 rounded-xl p-4 border border-amber-200">
								<div className="flex items-start gap-3">
									...
									<div>
										<p className="text-sm font-medium text-amber-800">Mode de paiement</p>
										<p className="text-xs text-amber-700 mt-1">
											Après validation, vous serez redirigé vers WhatsApp pour finaliser le paiement par Wave, Orange Money ou MTN.
										</p>
									</div>
								</div>
							</div>

			...
			<div className="min-h-screen bg-slate-50">
				<header className="bg-white border-b border-slate-200">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
						<Link href="/" className="inline-flex items-center gap-2 text-slate-600 hover:text-[#1B75BC] transition-colors">
					...
					<div className="text-center">
						<div className="w-24 h-24 mx-auto mb-6 rounded-full bg-slate-100 flex items-center justify-center">
							<svg className="w-12 h-12 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121 0 2.002-.881 2.002-2.003V6.75H5.625m1.875 7.5L6.106 5.272M7.5 14.25L5.106 5.272" />
							</svg>
						</div>
						<h1 className="text-2xl font-bold text-slate-900 mb-2">Votre panier est vide</h1>
						<p className="text-slate-500 mb-8">Découvrez nos licences logicielles professionnelles</p>
						<Link
							href="/products"
			...
			<header className="bg-white border-b border-slate-200">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
					<div className="flex items-center justify-between">
						<Link href="/products" className="inline-flex items-center gap-2 text-slate-600 hover:text-[#1B75BC] transition-colors">
							<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
							</svg>
							Continuer mes achats
						</Link>
						<h1 className="text-lg font-bold text-slate-900">Mon Panier ({itemCount})</h1>
						<button
							type="button"
									...
									<div className="flex-1 min-w-0">
										<div className="flex items-start justify-between gap-4">
											<div>
												...
												<p className="text-sm text-slate-500 mt-0.5">Licence 1 an</p>
											</div>
											<button
												type="button"
							...
							<div className="mb-5">
								...
								<div className="flex gap-2">
									<input
										...
										className="flex-1 px-4 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-[#1B75BC] transition-colors"
									...
									<button
										...
										className="px-4 py-2.5 bg-slate-100 text-slate-700 font-medium rounded-xl hover:bg-slate-200 transition-all disabled:opacity-50 text-sm"
									>
										{promoApplied ? 'Appliqué' : 'Appliquer'}
									</button>
								</div>
								{promoApplied && (
									<p className="text-sm text-green-600 mt-2">Code promo appliqué : -10%</p>
								)}
							</div>

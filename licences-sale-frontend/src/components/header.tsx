				...
				<div className="max-w-[1400px] mx-auto px-12 lg:px-16 xl:px-20 flex items-center justify-between h-[40px] relative z-10">
					...
					<div className="flex items-center gap-6">
						<a
							...
							className="flex items-center gap-2 text-white/90 text-[13px] hover:text-white transition-all duration-300 group"
						>
							<svg
								className="w-4 h-4 group-hover:animate-[wiggle_0.5s_ease-in-out]"
								fill="currentColor"
								viewBox="0 0 24 24"
							>
					...
					<div className="flex items-center gap-4">
						...
						>
							...
							>
								...
								<svg
									className={`w-3 h-3 transition-transform ${currencyDropdownOpen ? 'rotate-180' : ''}`}
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
									strokeWidth={2}
							...
							{currencyDropdownOpen && (
								<div className="absolute top-full right-0 pt-1 z-[100]">
									<div
										role="menu"
										className="bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden min-w-[130px]"
									>
				...
				<div className="max-w-[1400px] mx-auto px-12 lg:px-16 xl:px-20">
					<div className="flex items-center justify-between h-[90px] gap-8">
						...
						<form
							...
							className="hidden md:flex flex-1 max-w-[600px] mx-auto"
						>
						...
						<div className="hidden lg:flex items-center gap-6 shrink-0">
							...
							{user ? (
											...
											<div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden min-w-[200px]">
												...
												<div className="py-2">
													{!(
														...
														<>
															<Link
																href="/compte"
																className="block px-4 py-2.5 text-[13px] text-gray-700 hover:bg-blue-50 hover:text-[#1D73B3] transition-colors"
															>
												...
												<div className="border-t border-gray-100 py-2">
													<Link
														...
														className="block px-4 py-2.5 text-[13px] text-red-600 hover:bg-red-50 transition-colors"
													>
														<span className="flex items-center gap-2">
															<svg
																className="w-4 h-4"
								...
								>
									...
									<div className="text-left">
										...
										<div className="text-[14px] font-semibold text-[#2E86AB]">
											Connexion
										</div>
									</div>
								</Link>
							...
							<Link
								href="/compte/favoris"
								className="relative text-gray-400 hover:text-[#E63946] transition-colors"
							>
								<svg
									className="w-7 h-7"
									fill="none"
							...
							<Link
								href="/cart"
								className="relative text-gray-400 hover:text-[#1B75BC] transition-colors"
							>
								<svg
									className="w-7 h-7"
									fill="none"
				...
				<div className="max-w-[1400px] mx-auto px-12 lg:px-16 xl:px-20">
					<nav className="flex items-center justify-between">
						...
						<div className="flex items-center gap-6">
							<Link
								href="/about"
								className="text-[13px] font-semibold text-[#1B3A5F] hover:text-[#2E86AB] transition-colors"
							>
								À propos
							</Link>
							<Link

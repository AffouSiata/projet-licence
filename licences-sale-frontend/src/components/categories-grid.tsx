					...
					{categories.slice(0, 6).map((category) => {
						...
						return (
							<Link
								...
								className="group"
							>
								<div className="relative flex items-start gap-5 p-7 lg:p-8 rounded-2xl bg-white border border-gray-100 hover:border-transparent hover:shadow-xl hover:shadow-gray-200/60 hover:-translate-y-1 transition-all duration-500 h-full overflow-hidden">
